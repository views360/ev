...
function calculate() {
    ...
    document.getElementById("adhocCostLine").innerHTML = `Total journey cost based on average regular public charging: <span class="highlight">£${core.totalAdhocCost.toFixed(2)}</span>`;
