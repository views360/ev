...
function calculate() {
    ...
    let html = `<table><thead><tr><th>Provider (click provider link for sub. info.)</th><th>Sub. Fee</th><th>Rate</th><th>Trip Cost</th><th>vs. PAYG</th><th>Break-even (public/total)</th></tr></thead><tbody>`;
    providers.forEach(p => {
