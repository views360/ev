...
function calculate() {
    ...
    let html = `<i style='font-size:0.7em; color: #AAA'>In mobile view, slide right to view hidden table columns, below:</i><table><thead><tr><th>Provider (click provider link for sub. info.)</th><th>Sub. Fee</th><th>Rate</th><th>Trip Cost</th><th>vs. PAYG</th><th>Break-even (public/total)</th></tr></thead><tbody>`;
    providers.forEach(p => {
