...
function calculate() {
    ...
    document.getElementById("preChargeLine").innerHTML = `<h3>PAYG Benchmark Stats</h3>Pre-journey starting charge: <strong>${startChargeKwh.toFixed(1)} kWh</strong> (£${startChargeCost.toFixed(2)})`;
