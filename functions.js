...
function calculate() {
    ...
    document.getElementById("homeRangeLine").innerHTML = `<div class="tooltip-container">
                          ...
                          <div class="tooltip-box tooltip-down tooltip-right">This is the distance you can expect to drive before your first public charge along your route.</div>Range from pre-journey starting charge: <strong>${initialRange.toFixed(0)} miles</strong>`;
    document.getElementById("publicMilesLine").innerHTML = `<div class="tooltip-container">
                            <span class="info-icon" style="font-size:0.8rem" onclick="toggleTooltip(this)">💡</span>
                          <div class="tooltip-box tooltip-down tooltip-right">This is how many miles of your trip will need to be covered by public charging.</div>PAYG public charging miles needed: <strong>${publicMiles.toFixed(0)} miles</strong> `;
