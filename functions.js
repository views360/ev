...
function calculate() {
 ...
 // ==========================================
    ...
    if (providers.length > 0) {
        ...
        const timeLine = `<p style="font-size: 1.1rem">Approximate driving time for ` + ${(inputs.journeyMiles} + ` miles at 60mph is <strong>${(inputs.journeyMiles / 60).toFixed(1)} hours</strong></p>.`;
        ...
        const speedTableHtml = `
            <div class="speed-comparison-container">
                <table class="mini-table">
                    <thead>
                        <tr><th>Speed</th><th>Estimated Charge Time for <strong>${publicKwh.toFixed(1)} kWh</th></tr>
                    </thead>
                    <tbody>
